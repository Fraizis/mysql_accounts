...
VALUES 
	...
	(1, 'Кредитный договор с Сидоровым И.П.', 1),
	(2, 'Депозитный договор с Сидоровым И.П.', 1),
	(3, 'Депозитный договор с Сидоровым И.П.', 1),
	(1, 'Депозитный договор с Иванов П.С.', 2),
	(2, 'Депозитный договор с Иванов П.С.', 2),
	(3, 'Депозитный договор с Иванов П.С.', 2)
;
"""
...
VALUES 
	...
	('Депозитный счет для Иванов П.С.', 3000, 2, 8, '42301810400050000001'),
	('Кредитный счет для Иванов П.С.', -1000, 2,  9, '45502810401020000022')
;
"""
